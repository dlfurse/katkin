#ifndef _katkin_expressions_divide_hh_
#define _katkin_expressions_divide_hh_

#include <katkin/expressions/expression.hh>
#include <katkin/expressions/double.hh>
#include <katkin/operations/divide.hh>

namespace katkin
{

    template< class subj_t >
    class _x< _divide< double, double >, subj_t >
    {
        public:
            typedef double r;
    ...
    template< class subj_t >
    class _x< _divide< float, float >, subj_t >
    {
        public:
            typedef float r;
